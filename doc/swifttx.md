...
This mechanism has been integrated into Bitcore-Node-DividendCash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/DividendCash-Project/insight-api-dividendcash#web-socket-api](https://github.com/DividendCash-Project/insight-api-dividendcash#web-socket-api) 
* API: [https://github.com/DividendCash-Project/insight-api-dividendcash#swifttx-transactions](https://github.com/DividendCash-Project/insight-api-dividendcash#swifttx-transactions) 
...
By default, the DividendCash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DividendCash Core daemon:
