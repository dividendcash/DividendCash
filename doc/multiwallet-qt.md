...
In order to support loading of multiple wallets in dividendcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dividendcash.cpp.
...
Changes to dividendcash.cpp
----------------------
dividendcash.cpp is the entry point into dividendcash-qt, and as such, will require some minor modifications to provide hooks for
