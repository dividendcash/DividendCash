...
Dividendcash now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<dividendcash_address\> \<monthly_payment_dividendcash\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ DividendCash, _12_ times over the course of a year totaling _24000_ DividendCash.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<dividendcash_address\> \<monthly_payment_dividendcash\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` DividendCash.
