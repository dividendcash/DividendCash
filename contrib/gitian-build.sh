...
VERSION=
commit=false
url=https://github.com/dividendcash-project/dividendcash
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the dividendcash, gitian-builder, gitian.sigs, and dividendcash-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/dividendcash-project/dividendcash
