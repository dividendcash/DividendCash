...
/** Utility functions used by the DividendCash Qt UI.
 */
namespace GUIUtil
{
...
// Render DividendCash addresses in monospace font
...
// Parse "dividendcash:" URI into recipient object, return true on successful parsing
