...
void OverviewPage::updateObfuscationProgress()
{
    ...
    QString strAnonymizeDividendcashAmount = BitcoinUnits::formatHtmlWithUnit(nDisplayUnit, nAnonymizeDividendcashAmount * COIN, false, BitcoinUnits::separatorAlways);
    ...
    if (currentBalance == 0) {
        ...
        strAnonymizeDividendcashAmount = strAnonymizeDividendcashAmount.remove(strAnonymizeDividendcashAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeDividendcashAmount + " / " + tr("%n Rounds", "", nObfuscationRounds);
    ...
    if (nMaxToAnonymize > nAnonymizeDividendcashAmount * COIN) nMaxToAnonymize = nAnonymizeDividendcashAmount * COIN;

    if (nMaxToAnonymize == 0) return;

    if (nMaxToAnonymize >= nAnonymizeDividendcashAmount * COIN) {
        ui->labelAmountRounds->setToolTip(tr("Found enough compatible inputs to anonymize %1")
                                              .arg(strAnonymizeDividendcashAmount));
        strAnonymizeDividendcashAmount = strAnonymizeDividendcashAmount.remove(strAnonymizeDividendcashAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeDividendcashAmount + " / " + tr("%n Rounds", "", nObfuscationRounds);
    } else {
...
void OverviewPage::toggleObfuscation()
{
    ...
    if (!fEnableObfuscation) {
        ...
        if (nAnonymizeDividendcashAmount == 0) {
