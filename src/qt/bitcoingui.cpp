                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DividendCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DividendCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dividendcash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DividendCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about DividendCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DividendCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DividendCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DividendCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a DividendCash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DividendCash Core help message to get a list with possible DividendCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DividendCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DividendCash network", "", count));
}
...
{
    QString strTitle = tr("DividendCash Core"); // default title
