...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DividendCash Core"),
     ...
     * override -datadir in the dividendcash.conf file in the default data directory
     * (to be consistent with dividendcashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
