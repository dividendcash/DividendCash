...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Dividendcash Core dividendcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dividendcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dividendcash transaction") + "\n" +
                               "  dividendcash-tx [options] -create [commands]   " + _("Create hex-encoded dividendcash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dividendcash transaction
