Contributing to DividendCash Core
============================

The DividendCash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DividendCash Core project, and is not to be
confused with overall DividendCash Network Protocol consensus changes.

Whether a pull request is merged into DividendCash Core rests with the project merge
...
Patches that change DividendCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the DividendCash consensus, it must have been
...
The project leader is the release manager for each DividendCash Core release.
